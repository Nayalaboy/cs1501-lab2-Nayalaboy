     ...
     while(true){
       switch(menu()){
         ...
         case 4:
             ...
             //TODO: create a new node that has the existing
             // tree as its right child and assign it to the bTree variable
             break;
         case 5:
   ...
   private BinaryNode<Character> readTree(Scanner file) throws IOException{
     ...
     if(file.hasNext()){
       ...
       if(line.charAt(0) == 'I'){ //internal node
         /*TODO: replace null below with a new node and recursively call readTree on its left and right children */
